...
public class SPUtils {
     ...
     * @param value
     */
    public void putPhoneCookie(@NonNull String key, @NonNull String value) {
        sp.edit().putString(SPKeyUtils.PHONE_COOKIE + key, value).apply();
    }

    public String getPhoneCookie(@NonNull String key) {
        return getString(SPKeyUtils.PHONE_COOKIE + key, "");
    }
     ...
     * @param value
     */
    public void putUserAgent(@NonNull String key, @NonNull String value) {
        sp.edit().putString(SPKeyUtils.USER_AGENT + key, value).apply();
    }

    public String getUserAgent(@NonNull String key) {
        return getString(SPKeyUtils.USER_AGENT + key, "");
    }
}
